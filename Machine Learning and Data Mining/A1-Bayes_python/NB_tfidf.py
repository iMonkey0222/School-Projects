#!src/bin/pyhton3
"""For prediction of the test data, NB-tfidf.py is the only file should be run.
   accuracy.py used for the analysis of our algorithm
"""
...
""" Instructions of running code:
	...
	We are using MacOS Terminal as an example to run our file:
		...
		then the output result will create at location ../output/final.txt with format:
		appName \t predict_labels
"""
